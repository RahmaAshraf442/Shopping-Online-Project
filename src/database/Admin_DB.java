...
public class Admin_DB {
   ...
   public static Connection connect() throws ClassNotFoundException{ 
    ...
    //.....................................................
    public static void insert(int id,String User_name,String Pass_word,int age,String department,String gender) throws ClassNotFoundException{
        try {
    ...
    //...........................................
     ...
     //************
      public static ArrayList<user> List_to_make_check() throws SQLException, ClassNotFoundException {
        ArrayList<user> list = new ArrayList<>();
        Connection con = connect();
        java.sql.PreparedStatement ps = con.prepareStatement("select * from Employee");
        ResultSet rs = ps.executeQuery();
      ...
      //************************************
      public static ArrayList<user> List2_to_make_check() throws SQLException, ClassNotFoundException {
        ArrayList<user> list = new ArrayList<>();
        Connection con = connect();
        java.sql.PreparedStatement ps = con.prepareStatement("select * from Employee");
        ResultSet rs = ps.executeQuery();
        while (rs.next()) {
            list.add(new user(rs.getInt("id"),rs.getString("password")));
            }
        return list;
    }
     // get id for search ...............
     ...
     public static ArrayList<user> search(int id) throws SQLException, ClassNotFoundException {
       ...
       public static void update(int id,String fname,String lname,String age,String add,String gender) throws ClassNotFoundException{
        try {
            Connection con=connect();
    ...
    } public static void update2(int id,String username,String pass,int age,Object gender) throws ClassNotFoundException{
        try {
            Connection con=connect();
    ...
    public static int Check(String us_name, String pass_wo,Object depart) throws SQLException, ClassNotFoundException {
        ArrayList<user> arrayList = List_to_make_check();
        int x = 0 ;
    ...
    public static int Check2(int id, String pass) throws SQLException, ClassNotFoundException {
        ArrayList<user> arrayList = List2_to_make_check();
        int x = 0 ;
        for (int i = 0; i < arrayList.size(); i++) {
            if (arrayList.get(i).getId() == id) {
                
               if (arrayList.get(i).getPassword().equals(pass)) {    
                    x = 1;
                    //successfull
                    break;
                } 
