...
public class inventory_db {
   ...
   public static Connection connect() throws ClassNotFoundException{ 
    ...
    float ammount=arr.get(0).getPro_ammount();
        ...
        public static float select2(int pid,float pammount) throws SQLException, ClassNotFoundException{
            ArrayList<products> arr=new ArrayList<>();
           arr= search(pid);
    ...
    float ammount=arr.get(0).getPro_ammount();
        ...
        public static float select3(int pid) throws SQLException, ClassNotFoundException{
            ArrayList<products> arr=new ArrayList<>();
            arr= search(pid);
           
            
         
           float price=arr.get(0).getPro_price();
    ...
    public static int make_order(int pid,float pammount) throws SQLException, ClassNotFoundException{
            ...
            public static void cancel_order(int pid,float pammount) throws SQLException, ClassNotFoundException{
            Connection con = connect();
            float f;
            f=select2( pid, pammount);
            java.sql.PreparedStatement pp = con.prepareStatement("update products set pro_ammount=? where pro_id=?");
            pp.setFloat(1, f);
            pp.setInt(2,pid );
            pp.executeUpdate();
