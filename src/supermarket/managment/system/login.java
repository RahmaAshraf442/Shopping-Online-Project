...
public class login extends JFrame implements ActionListener {
    ...
    JOptionPane message;
    image im = new image();
    String[] items={"Admin","Inventory","Sales","Marketing"}; 
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == Login) {
            ...
            try {
                ...
                if (i == 0) {
                    message.showMessageDialog( frame , "information not matched");
                } else if (i == 1) {
                    ...
                    if( department.getSelectedItem().equals("Admin") ){
                          ...
                          this.dispose();
                           new marketing_main().shoe();
                          // put calling to Marketting screen
                    }
                     else if (department.getSelectedItem().equals("Sales")){
                          this.dispose();
                          new sales_screen().show_sales_screen();
                    }
