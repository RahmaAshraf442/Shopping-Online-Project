...
public class update_emp extends JPanel implements ActionListener {
    ...
    public update_emp() throws SQLException, ClassNotFoundException {
        ...
        Update.setBounds(410, 260, 100, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == Update) {
            try {
                ...
                database.Admin_DB.update(Integer.parseInt(id1.getText().trim()),fname1.getText(), 
                                          lname1.getText(), age1.getText(), add1.getSelectedItem().toString(), gender1.getSelectedItem().toString());
