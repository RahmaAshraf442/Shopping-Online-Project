        ...
        if (e.getSource() == Update) {
            try {
                if (pro_name1.getText().isEmpty() && pro_price1.getText().isEmpty() && pro_ammount1.getText().isEmpty() && pro_id1.isEditable()) {
                    ...
                    database.inventory_db.update(Integer.parseInt(pro_id1.getText().trim()), pro_name1.getText(),
                            Float.parseFloat(pro_price1.getText().trim()), Float.parseFloat(pro_ammount1.getText().trim()));
                    pro_name1.setText("");
                    pro_ammount1.setText("");
                    pro_id1.setText("");
                    pro_price1.setText("");
